...
export class PaymentComponent implements OnInit {
  ...
  confirmCreditCard() {
    ...
    if (this.paymentForm.valid) {
      ...
      this.toastrService.error("Veuillez remplir complètement les informations de votre carte", "Les informations de la carte sont manquantes")
    }
  }
  ...
  deleteCreditCard(creditCard: CreditCard) {
    this.getCustomerId().then((customerId) => {
      ...
      this.creditCardService.deleteCreditCard(customerCreditCardModel).subscribe(() => {
        ...
        this.toastrService.success("Votre carte de crédit enregistrée a été supprimée avec succès", "La carte de crédit a été supprimée");
      }, () => {
        this.toastrService.error("Un problème est survenu lors du traitement de votre carte de crédit enregistrée", "Échec de la suppression de la carte de crédit");
      })
    })
  }
