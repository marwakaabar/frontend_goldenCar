...
export class CarDeleteComponent implements OnInit {
  ...
  delete(car: Car) {
    this.carService.delete(car).subscribe(response => {
      this.toastrService.success(car.brandName + " " + car.modelName + " voiture supprimé", "Suppression réussie");
      this.closeCarDeleteModal();
    }, errorResponse => {
      this.toastrService.error(errorResponse.error.message, "La suppression a échoué");
    })
  }
